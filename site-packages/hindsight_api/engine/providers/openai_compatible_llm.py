...
- MiniMax: MiniMax-M3 (1,000,000-token context) and MiniMax-M2.7 (204,800-token context)
...
class OpenAICompatibleLLM(LLMInterface):
    ...
    - LMStudio: Local models with OpenAI-compatible API
    - MiniMax: MiniMax-M3 and MiniMax-M2.7 models via OpenAI-compatible APIs
      (https://api.minimax.io/v1 and https://api.minimaxi.com/v1)
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # Validate provider
        valid_providers = ["openai", "groq", "ollama", "lmstudio", "llamacpp", "minimax", "minimax-cn", "volcano", "openrouter"]
        ...
        if self.provider in ("openai", "groq", "minimax", "minimax-cn", "openrouter") and not self.api_key:
    ...
    def _max_tokens_param_name(self) -> str:
        ...
        if self.provider == "openai" and self.base_url and ".openai.azure.com" in self.base_url:
            return "max_completion_tokens"
        # openai with custom base_url, ollama, lmstudio, minimax, minimax-cn, volcano —
