...
def _list_recent_sessions(db, limit: int, current_session_id: str = None, user_id: str = None, source: str = None) -> str:
...
def session_search(
    ...
    if not query or not isinstance(query, str) or not query.strip():
        return _list_recent_sessions(db, limit, current_session_id, user_id=user_id, source=source)
