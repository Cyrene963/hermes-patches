...
const translations = {
  en: {
    ...
    'review.graph_changes_plain': 'Approved changes',
    'review.pending_memories': 'Memory suggestions',
    'review.waiting_for_review': 'Waiting for review',
    'review.review_this_memory': 'Review this memory suggestion',
    'review.waiting_for_you': 'waiting for you',
    'review.reject_suggestion': 'Reject suggestion',
    'review.approve_and_write': 'Approve and write',
    'review.what_to_do_title': 'What should I do?',
    'review.what_to_do_desc': 'Check whether the proposed memory is true and useful. If it is correct, approve it; if it is wrong, reject it.',
    'review.redacted_warning': 'This item is still redacted, so do not approve it until enough content is visible.',
    'review.step_check': '1. Check',
    'review.step_check_desc': 'Read the proposed memory and its evidence.',
    'review.step_approve': '2. Decide',
    'review.step_approve_desc': 'Approve writes it into Memory Graph after verification.',
    'review.step_convert_desc': 'This one needs manual conversion before writing.',
    'review.step_undo': '3. Undoable',
    'review.step_undo_desc': 'Approved writes create a rollback record.',
    'review.system_judgement': 'System judgement',
    'review.proposed_memory': 'Proposed memory',
    'review.evidence_for_memory': 'Why this was suggested',
    'review.technical_details': 'Technical details',
    'review.ready_to_confirm': 'Ready',
    'review.ready_memory_bucket': 'Ready memories',
    ...
    'review.approve_title': 'Approve into Memory Graph with readback verification',
    'review.can_write': 'Can write',
    'review.needs_conversion': 'Needs conversion',
    ...
    'review.only_ready_memory_approvable': 'Only already-distilled ready memories can be approved. Source material must be summarized first.',
  ...
  zh: {
    ...
    'review.graph_changes_plain': '已批准更改',
    'review.pending_memories': '待确认记忆',
    'review.waiting_for_review': '等待你确认',
    'review.review_this_memory': '确认这条记忆要不要留下',
    'review.waiting_for_you': '等待确认',
    'review.reject_suggestion': '不要这条',
    'review.approve_and_write': '确认写入',
    'review.what_to_do_title': '你现在要做什么？',
    'review.what_to_do_desc': '看下面“建议写入的记忆”和“为什么建议”。如果这条记忆真实、有用，就点“确认写入”；如果不对，就点“不要这条”。',
    'review.redacted_warning': '这条仍然被遮住，信息不够，不建议直接批准。先让系统显示足够内容或跳过。',
    'review.step_check': '1. 先看内容',
    'review.step_check_desc': '确认这是不是你真的希望我记住的事。',
    'review.step_approve': '2. 再决定',
    'review.step_approve_desc': '确认写入后会进入 Memory Graph，并自动验证能不能搜回。',
    'review.step_convert_desc': '这条不能直接写，需要先转成技能/规则/私有记忆。',
    'review.step_undo': '3. 可回滚',
    'review.step_undo_desc': '写入成功后会产生变更记录，之后可撤销。',
    'review.system_judgement': '系统判断',
    'review.proposed_memory': '建议写入的记忆',
    'review.evidence_for_memory': '为什么建议记住',
    'review.technical_details': '技术细节',
    'review.ready_to_confirm': '可写入',
    'review.ready_memory_bucket': '可写入记忆',
    ...
    'review.approve_title': '写入 Memory Graph 并执行读回验证',
    'review.can_write': '可写入',
    'review.needs_conversion': '需转换',
    ...
    'review.only_ready_memory_approvable': '只有已经蒸馏好的可写入记忆才能批准；原始素材必须先归纳成稳定记忆。',
