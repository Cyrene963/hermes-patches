...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, hermes_home):
        ...
        try:
            ...
            logger.debug("Could not chmod Hindsight config file %s", config_path, exc_info=True)
    ...
    def get_config_schema(self):
        return [
            ...
            # Local embedded mode
            {"key": "llm_provider", "description": "LLM provider", "default": "openai", "choices": ["openai", "anthropic", "gemini", "groq", "openrouter", "minimax", "minimax-cn", "ollama", "lmstudio", "openai_compatible"], "when": {"mode": "local_embedded"}},
    ...
    def _format_recall_context(self, text: str) -> str:
    ...
    def prefetch(self, query: str, *, session_id: str = "") -> str:
        ...
        with self._prefetch_lock:
            ...
            self._prefetch_result = ""
        if not result:
            logger.debug("Prefetch: no cached results; synchronously recalling current query")
            try:
                sync_query = query
